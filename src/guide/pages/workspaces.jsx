...
export function CRMWorkspacesPage() {
  return (
    <div className="prose">
      ...
      <p>While CRM Search is open, the Actions Shelf can expose <strong>Run last query</strong> and <strong>Scan for recent orders</strong>. The scan requires a saved query named exactly <strong>My Clients</strong>; the first run covers the previous seven days, then later runs continue from the stored watermark. Task List similarly adds <strong>Only overdue + due today</strong> while that modal is open.</p>
