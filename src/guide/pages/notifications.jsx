  ...
  return (
    <div className="prose">
      ...
      <div className="reference-split">
        <NotificationPreview />
        <div>
          <p>The popup has a <strong>Notifications</strong> button with the unread count. Chrome’s toolbar icon carries the same badge, capped at 99+. Every new system update also appears at the top-right of an active Golfballs page as either a compact tag or an action card.</p>
      ...
      <div className="docnote info">
        ...
        <div className="dn-b">
          ...
          <p>Action notifications carry an option label and an opaque payload. The backend stores that text without knowing its command; the installed extension parses it and runs only commands compiled into that version. Current payloads can open a CRM contact, a completed mockup batch, or a support ticket, and the other option is always <strong>Dismiss</strong>.</p>
        </div>
      </div>
