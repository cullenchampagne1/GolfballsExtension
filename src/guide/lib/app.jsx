...
export const NAV = [
  ...
  { group: 'Stay Organized', items: [
    { id: 'watchlist', title: 'Watch List', icon: 'eye', wip: true, slugs: ['watch-list'] },
    { id: 'tasks', title: 'Task List', icon: 'check', wip: true, slugs: ['task-list'] },
    { id: 'quicktask', title: 'Quick Task', icon: 'bolt', wip: true, slugs: ['quick-task'] },
    { id: 'calls', title: 'Call Log', icon: 'phone', wip: true, slugs: ['call-log'] },
    { id: 'calendar', title: 'Order Dates', icon: 'clock', wip: true, slugs: ['order-date-manager'] },
  ]},
  { group: 'Find People', items: [
    { id: 'crm-search', title: 'CRM Search', icon: 'search', wip: true, slugs: ['crm-search', 'phone-finder'] },
    { id: 'crm-query', title: 'Query Builder', icon: 'filter', wip: true, slugs: ['query-builder'] },
    { id: 'crm-new', title: 'New Contact', icon: 'user', wip: true, slugs: ['new-contact'] },
  ]},
