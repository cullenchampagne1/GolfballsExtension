...
// The legacy "Copy" button that used to live in the Order List portlet
// title was removed in favor of the actions-shelf "Copy order IDs"
// action (see src/content/actions-shelf.jsx registerCopyOrdersAction).
