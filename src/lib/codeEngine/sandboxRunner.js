...
export function buildTraceBody(instrumentedCode) {
  return [
    ...
    '    this.body = (this.body || "") + "<p><a href=\\\"" + href + "\\\">" + esc(label || "View your proposal") + "</a></p>"; return this;',
    '  };',
    '  return o;',
    '};',
    'const __mkOut = (ref) => {',
    ...
    '  const plain = Object.assign({}, out); delete plain.append; delete plain.appendSubject; delete plain.attachProposal;',
    ...
    // Action inputs must cross postMessage back to the content script. Evaluated
    // outbound objects carry convenience methods, which are not structured-
    // cloneable; project every input to plain data at the recording boundary.
