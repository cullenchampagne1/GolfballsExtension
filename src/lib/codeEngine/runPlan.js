...
const EFFECT_CONTRACTS = ['sendEmail', 'createTask', 'logCall', 'completeTask', 'editContact'];
...
export function planRun(trace, audienceCount = 1) {
  ...
  const writes = counts.createTask + counts.logCall + counts.completeTask + counts.editContact;
