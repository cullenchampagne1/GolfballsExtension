...
export async function readCallContext() {
  ...
  /* These read the CURRENT contact you're viewing (the customerID in the
     URL / the contact-page labels). Intentionally NOT the page-engine
     schema: on an account page the engine resolves a *representative*
     contact, which is the wrong subject for attaching a call log. */
