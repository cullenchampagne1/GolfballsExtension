...
/* The aggregate items table carries no item id / product URL (the cell is
   plain text), so a true deep-link isn't possible — link to a storefront
   search by item name instead. */
