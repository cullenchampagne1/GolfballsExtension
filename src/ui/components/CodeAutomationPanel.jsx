          ...
          {view === 'code' ? (
            <motion.div key="code"
              ...
              <div style={{ flexShrink: 0, fontSize: 10, color: 'var(--gb-text-muted)', lineHeight: 1.5 }}>
                <b>page.*</b> is the hydrated audience record being run. <b>user.*</b> are your saved emails/tasks/calls. <b>actions.*</b> can send email, create/edit tasks and opportunities, log activity, and build current-catalog proposals from prior orders or SKUs.
              </div>
              {errors.length ? (
