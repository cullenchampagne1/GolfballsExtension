...
export const I = {
  ...
  arch:   (p) => <Icon {...p}><rect x="3" y="5" width="18" height="4" rx="1" /><path d="M5 9v11h14V9M9 13h6" /></Icon>,
  ban:    (p) => <Icon {...p}><circle cx="12" cy="12" r="9" /><path d="M5.6 5.6l12.8 12.8" /></Icon>,
  briefcase: (p) => <Icon {...p}><rect x="3" y="7" width="18" height="13" rx="2" /><path d="M8 7V5a2 2 0 012-2h4a2 2 0 012 2v2M3 12h18M10 12v2h4v-2" /></Icon>,
