...
for (const v of VARIANTS) {
  ...
  const manifest = {
    ...
    theme: {
      colors: {
        // frame (= inactive tabs) stays the deep surface; the toolbar (=
        // the ACTIVE tab) uses a lighter "secondary" surface so the active
        // tab is distinguishable from the rest. omnibox a touch lighter.
        frame: deep,
        frame_inactive: deep,
        toolbar,
