...
describe('developer settings · Sales Fantasy event', () => {
  ...
  it('gates the event launcher and opens the full Sales Fantasy window', () => {
    ...
    assert.match(salesFantasyButtonSource, /height: 36, padding: '0 8px'/);
    ...
    assert.match(salesFantasyButtonSource, /stopColor="var\(--gb-brand-label\)"/);
    assert.match(salesFantasyButtonSource, /fill="url\(#sales-fantasy-wave\)"/);
    assert.match(salesFantasyButtonSource, /fill="url\(#sales-fantasy-wave\)"\s+opacity="0\.22"/);
    assert.match(salesFantasyButtonSource, /stroke="url\(#sales-fantasy-wave\)"/);
    assert.match(salesFantasyButtonSource, /strokeWidth="8"/);
    assert.match(salesFantasyButtonSource, /opacity="0\.58"/);
    assert.match(salesFantasyButtonSource, /clipPath="url\(#sales-fantasy-wave-clip\)"/);
    assert.match(salesFantasyButtonSource, /vectorEffect="non-scaling-stroke"/);
    assert.doesNotMatch(salesFantasyButtonSource, /stroke="var\(--gb-brand-label\)"|strokeWidth="1\.25"/);
