...
(function installAnonymousApiClient(root) {
  ...
  // Global transport safety guard for every extension JSON request/response.
  // Shares have no product-level content, count, or storage quota; this only
  // prevents the authenticated fetch primitive from buffering an unbounded
  // string in one service-worker call.
